...
MonoBehaviour:
  ...
  m_Name: 
  m_EditorClassIdentifier: SingularityGroup.HotReload.Editor::SingularityGroup.HotReload.Editor.HotReloadWindow
  m_MinSize: {x: 50, y: 50}
  m_MaxSize: {x: 4000, y: 4000}
  m_TitleContent:
    m_Text: ' Hot Reload'
...
MonoBehaviour:
  ...
  m_OverlayCanvas:
    ...
    - dockPosition: 2
      ...
      index: 1
      contents: '{"m_Layout":4,"m_Collapsed":false,"m_Folded":false,"m_Floating":false,"m_FloatingSnapOffset":{"x":-951.0,"y":-36.0},"m_SnapOffsetDelta":{"x":0.0,"y":0.0},"m_FloatingSnapCorner":3,"m_Size":{"x":0.0,"y":0.0},"m_SizeOverridden":false}'
      floating: 0
      collapsed: 0
      snapOffset: {x: -951, y: -36}
      snapOffsetDelta: {x: 0, y: 0}
      snapCorner: 3
      layout: 4
      size: {x: 0, y: 0}
    ...
    - dockPosition: 2
      ...
      index: 0
      contents: '{"m_Layout":4,"m_Collapsed":false,"m_Folded":false,"m_Floating":false,"m_FloatingSnapOffset":{"x":-880.0,"y":-36.0},"m_SnapOffsetDelta":{"x":0.0,"y":0.0},"m_FloatingSnapCorner":3,"m_Size":{"x":0.0,"y":0.0},"m_SizeOverridden":false}'
      floating: 0
      collapsed: 0
      snapOffset: {x: -880, y: -36}
      snapOffsetDelta: {x: 0, y: 0}
      snapCorner: 3
      layout: 4
      size: {x: 0, y: 0}
...
MonoBehaviour:
  ...
  m_ZoomArea:
    ...
    m_VBaseRangeMin: -150.5
    m_VBaseRangeMax: 150.5
    ...
    m_MinimalGUI: 1
  m_defaultScale: 1
  m_LastWindowPixelSize: {x: 569, y: 322}
  m_ClearInEditMode: 1
  m_NoCameraWarning: 1
...
MonoBehaviour:
  ...
  m_OverlayCanvas:
    ...
    - dockPosition: 0
      ...
      id: Tool Settings
      index: 2
      contents: '{"m_Layout":1,"m_Collapsed":false,"m_Folded":false,"m_Floating":false,"m_FloatingSnapOffset":{"x":0.0,"y":0.0},"m_SnapOffsetDelta":{"x":0.0,"y":0.0},"m_FloatingSnapCorner":3,"m_Size":{"x":0.0,"y":0.0},"m_SizeOverridden":false}'
      floating: 0
      collapsed: 0
      snapOffset: {x: 0, y: 0}
      snapOffsetDelta: {x: 0, y: 0}
  ...
  m_Position:
    m_Target: {x: -0.24517822, y: 0.05381012, z: 0.21174526}
    speed: 2
    m_Value: {x: -0.24517822, y: 0.05381012, z: 0.21174526}
  m_RenderMode: 0
  m_CameraMode:
    drawMode: 0
    name: Shaded
  ...
  m_Grid:
    ...
    m_gridOpacity: 0.5
  m_Rotation:
    m_Target: {x: -0.08849165, y: 0.89651424, z: -0.20831496, w: -0.38083696}
    speed: 2
    m_Value: {x: -0.088491626, y: 0.896514, z: -0.20831491, w: -0.38083687}
  m_Size:
    m_Target: 10
    speed: 2
    m_Value: 10
...
MonoBehaviour:
  ...
  m_SearchFilter:
    ...
    m_SearchArea: 1
    m_Folders:
    - Assets/KlinketStudiosTools/Layouts
    m_Globs: []
    m_ProductIds: 
  ...
  m_LastProjectPath: C:\Users\Nicholas Klusman\Documents\UnityProjects\GitTemplate
  m_LockTracker:
    m_IsLocked: 0
